...
// ReSharper restore CheckNamespace
{
	...
	public interface IConnectionConfigurationValues
	{
		...
		/// <summary>
		/// Instead of following a c/go like error checking on response.IsValid always throw an OrientdbServerException
		...
		/// </summary>
		bool ThrowOnOrientdbServerExceptions { get;  }
		...
		/// </summary>
		Action<IOrientdbResponse> ConnectionStatusHandler { get; }

		/// <summary>
		/// 
		/// </summary>
        IOrientdbSerializer Serializer { get; set; }

		/// <summary>
		/// Basic access authorization credentials to specify with all requests.
		/// </summary>
        BasicAuthenticationCredentials BasicAuthorizationCredentials { get; } 
	}
}