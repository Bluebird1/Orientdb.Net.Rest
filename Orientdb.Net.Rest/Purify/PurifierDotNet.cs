...
namespace Orientdb.Net.Purify
{
    internal class PurifierDotNet : IPurifier
    {
        ...
        static PurifierDotNet()
        {
            ...
            Type infoFieldType = infoField.FieldType;
            ...
            Type moreInfoType = moreInfoField.FieldType;
        ...
        public void Purify(Uri uri)
        {
            ...
            string abs = uri.AbsoluteUri; //need to access this as well the MoreInfo prop is initialized.
            var flags = (ulong) flagsField.GetValue(uri);
